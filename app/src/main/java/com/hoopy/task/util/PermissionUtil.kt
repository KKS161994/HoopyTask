 ...
 *
 */
class PermissionUtil(var activity: Activity, val showAlertCallback: ShowAlertCallback) {
    var count = 0;
    private var beforeClickPermissionRat = ActivityCompat.shouldShowRequestPermissionRationale(
